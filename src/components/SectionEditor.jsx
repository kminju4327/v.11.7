...
export default function SectionEditor({section,onSave,onClose,onAIImproveRequest}){
 ...
 return <div style={{padding:20}}>
  ...
  <div style={{marginTop:20}}>
   ...
   />
   <button onClick={()=>onAIImproveRequest && onAIImproveRequest({section,data,instruction:aiInstruction})}>AI 개선 요청</button>
  </div>
